...
import cc.dreamcode.antiuuidspoof.config.MessageConfig;
import cc.dreamcode.antiuuidspoof.config.PluginConfig;
...
public final class AntiUUIDSpoofPlugin extends DreamBukkitPlatform implements DreamBukkitConfig, DreamPersistence {

    @Getter private static AntiUUIDSpoofPlugin antiUUIDSpoofPlugin;

    @Override
    public void load(@NonNull ComponentManager componentManager) {
        antiUUIDSpoofPlugin = this;
    }
    ...
    public @NonNull DreamVersion getDreamVersion() {
        return DreamVersion.create("Dream-AntiUUIDSpoof", "1.0-InDEV", "Nightusio");
    }
